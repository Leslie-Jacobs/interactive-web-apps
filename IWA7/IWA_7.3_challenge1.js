...
//this can be done using the Number() operator  

console.log(Number(value) + 4 + Number(value)); //logs final results

console.log(typeof Number(value)); //displays type of operator
