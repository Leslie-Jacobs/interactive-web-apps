...
const book1_canCheckIn = document.querySelector('#book1 .canCheckIn');
...
const book2_canCheckIn = document.querySelector('#book2 .canCheckIn');
...
const book3_canCheckIn = document.querySelector('#book3 .canCheckIn');
